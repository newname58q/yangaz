...
async def a(client, message: Message):
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    m = await message.reply(f"**{Bn} :-** 🔍 ᴀʀᴀɴɪʏᴏʀ {query}")
    ...
    try:
        ...
        try:
            ...
            m.edit(f"**{Bn} :-** 😕 ʜɪᴄʙɪʀ ꜱᴇʏ ʙᴜʟᴀᴍᴀᴅɪᴍ. ʏᴀᴢɪᴍɪ ʙɪʀᴀᴢ ᴅᴇɢɪꜱᴛɪʀᴍᴇʏɪ ᴅᴇɴᴇ..\n\n{e}")
            return
    except Exception as e:
        m.edit(
           f"**{Bn} :-** 😕 ʜɪᴄʙɪʀ ꜱᴇʏ ʙᴜʟᴀᴍᴀᴅɪᴍ. ᴜᴢɢᴜɴᴜᴍ.\n\nʙᴀꜱᴋᴀ ʙɪʀ ᴋᴇʟɪᴍᴇ ᴅᴇɴᴇʏɪɴ ᴠᴇʏᴀ ᴅᴜᴢɢᴜɴ ᴅᴜᴢᴇɴʟᴇʏɪɴ."
        )
        print(str(e))
        return
